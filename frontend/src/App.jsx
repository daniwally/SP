                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginTop: '20px' }}>
                  ...
                  <div style={{ background: 'rgba(0, 0, 0, 0.5)', padding: '18px', borderRadius: '12px', border: '1px solid rgba(217, 70, 239, 0.2)' }}>
                    <div style={{ marginBottom: '12px' }}>
                      ...
                      <p style={{ color: '#fbbf24', margin: '4px 0 0 0', fontSize: '1.02em', fontWeight: 800 }}>{testData.totales?.hoy?.ordenes || 0} órdenes</p>
                  ...
                  <div style={{ background: 'rgba(0, 0, 0, 0.5)', padding: '18px', borderRadius: '12px', border: '1px solid rgba(217, 70, 239, 0.2)' }}>
                    <div style={{ marginBottom: '12px' }}>
                      ...
                      <p style={{ color: '#fbbf24', margin: '4px 0 0 0', fontSize: '1.02em', fontWeight: 800 }}>{testData.totales?.semana?.ordenes || 0} órdenes</p>
                  ...
                  <div style={{ background: 'rgba(0, 0, 0, 0.5)', padding: '18px', borderRadius: '12px', border: '1px solid rgba(217, 70, 239, 0.2)' }}>
                    <div style={{ marginBottom: '12px' }}>
                      ...
                      <p style={{ color: '#fbbf24', margin: '4px 0 0 0', fontSize: '1.02em', fontWeight: 800 }}>{testData.totales?.año?.ordenes || 0} órdenes</p>
