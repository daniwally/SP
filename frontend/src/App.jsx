    ...
    return (
      <div className="loading-screen">
        ...
        <div className="loading-content">
          <h1 className="brand-logo" style={{ fontSize: '4em', marginBottom: '0' }}><span className="brand-command">ONEMANDO</span><span className="brand-dot">.</span><span className="brand-ai">ai</span></h1>
